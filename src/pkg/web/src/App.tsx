...
import IntegrationsGitHubInstalled from "./pages/settings/github_installed";
...
function App() {
  return (
    ...
    >
      <BrowserRouter>
        <Routes>
          {/* Empty layout for popup pages */}
          <Route element={<EmptyLayout />}>
            <Route
              path="integrations/callback/github"
              element={<ProtectedPage><IntegrationsGitHubCallback /></ProtectedPage>}
            />
            <Route path="integrations/github/installed" element={<IntegrationsGitHubInstalled />} />
          </Route>
          ...
          <Route element={
            ...
            <Route path="apps">
              ...
              >
                ...
                <Route path="spa/deployments" element={<AppDeployments />} />
                <Route path="spa/deployments/:deploymentId" element={<AppDeploymentDetails />} />
                <Route path="api/deployments" element={<AppApiDeployments />} />
                <Route path="api/deployments/:deploymentId" element={<AppApiDeploymentDetails />} />

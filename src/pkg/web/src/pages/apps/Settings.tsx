...
import { Settings, Globe, FileCode, Key, Earth } from "lucide-react";
import { cn } from "@/lib/utils";

export { GeneralTab, ApiTab, PagesTab, EnvironmentTab, DomainsTab } from "./settings/index";
...
const navItems = [
  ...
  { path: "domains", label: "Domains", icon: Earth },
];

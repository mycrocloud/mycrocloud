...
public class SlackAppService
{
    ...
    public SlackAppService(IConfiguration configuration, LinkGenerator linkGenerator, AppDbContext appDbContext, IHttpClientFactory httpClientFactory)
    {
    ...
    {
        var secret = _configuration.GetSection("ExternalIntegrations:Slack")["LinkSecret"];
    ...
    public async Task SendSlackEphemeralMessage(string slackTeamId, string channelId, string slackUserId, string text)
    {
        ...
        await http.PostAsJsonAsync("https://slack.com/api/chat.postEphemeral", payload);
    }
    ...
    public async Task SendSlackMessage(string slackTeamId, string channelId, string text)
    {
        ...
        await http.PostAsJsonAsync("https://slack.com/api/chat.postMessage", payload);
    }
